...
const RETRONAV_PROJECTS: Project[] = [
  ...
  {
    title: "LoRaPWN",
    description: "Research project on LoRaWAN security. Includes a custom implementation of the LoRaWAN MAC Layer using ChaCha20-Poly1305. Also includes an auditing framework for detecting anamolous packets and device behaviours in LoRaWAN networks using ML and vector databases.",
