(function (wp) {
	...
	// Register Hooks
	addFilter('blocks.registerBlockType', 'hcl/add-language-attribute', addLanguageAttribute);

	addFilter('editor.BlockEdit', 'hcl/with-language-control', withLanguageControl);

	addFilter('blocks.getSaveElement', 'hcl/modify-save-element', addLanguageClassToCodeElement);
})(window.wp);
